...
(function(){
  try{
    ...
    h+='<div class="stk-g" style="margin-top:12px">Путь 3 · Напрямую в Google Drive — с компьютера и для длинных видео</div>';
    h+='<div class="lsn">Открой ссылку ниже, выбери папку и перетащи файлы. Не знаешь, в какой раздел — кидай в <b>«00 Всё сюда»</b> внутри объекта (первая в списке), я разберу. О любой загрузке я узнаю сам в течение часа.</div>';
