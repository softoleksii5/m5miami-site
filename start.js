...
var EPLAN=[
 {m:'Август', tag:'Фундамент', items:[
   ['✅','LLC подана (07.08) — «M5 Miami Studio»','Заявка запущена 07.08, точное написание имени сверим по документам регистрации. Дальше сами придут: approval штата → EIN. Как получишь документы — скажи Клоду: обновит статусы и запустит триггеры (банк-чеклист, QuickBooks, Google Ads-профиль Organization).'],
...
var ALEXTODO=[
 ...
 ['done','LLC подана 07.08 — «M5 Miami Studio»','Имя сверить по регистрационным документам. Ждём approval штата и EIN — как придут документы, скажи Клоду: запустит банк-чеклист, QuickBooks и Google Ads (профиль Organization).','m'],
