...
var ALEXTODO=[
 ...
 ['todo','Porkbun: включить preview.m5miami.com (CNAME)','На заглушке боевого теперь код 2026 → открывает полный сайт. Но поддомен preview без DNS-записи не работает: Porkbun → m5miami.com → DNS → добавить CNAME, host: preview, answer: softoleksii5.github.io. Через 5–30 мин GitHub выпустит сертификат — код заработает. API-ключей Porkbun у Клода нет, шаг ручной (2 мин).','m'],
