...
(function(){
  try{
    ...
    h+='<div class="lsn"><b>Отправь файл боту и напиши название объекта. Всё.</b><br>@m5miami_bot заберёт фото и видео сам, создаст папку объекта в Drive, а я разберу, где «до», где «процесс», где «после». Раскладывать по папкам не нужно — это моя работа, не ваша.<br><br><b>Единственное исключение — длинное видео:</b> телефон предупредит, что файл большой. Тогда залей его в папку <b>00 Входящее</b> (ссылка ниже) и напиши боту строку, что это за объект.</div>';
